              ...
              <td style={{ padding: '1rem', display: 'flex', gap: '1rem', alignItems: 'center' }}>
                ...
                <div>
                  <div style={{ fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    {post.isLocked && (
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c62828" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" title="Locked (Hidden from public)">
